"""Build site/pages/merit-tier.html from site/pages/_merit_tier_extracted.html."""
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
SRC = ROOT / "site/pages/_merit_tier_extracted.html"
if not SRC.is_file():
    raise SystemExit("Missing site/pages/_merit_tier_extracted.html — save the standalone Merit Tier HTML there first.")
...
tier = """          <p class="tier-kicker"><a href="people.html">People</a> · <a href="citizenship.html">Citizenship</a> · Civic record</p>
          <p class="zone-intro">Three merit tiers, eight earning categories, and a point system assessed at the Veloran and every two years — private on the CID, consequential for access and opportunity.</p>
"""
...
<head>
  ...
  <title>Merit Tier System — VAULTRIA</title>
  ...
  <link rel="stylesheet" href="../assets/css/merit-tier.css" />
</head>
  ...
  <div class="site-shell">
    ...
    <div class="site-main">
      ...
      <div class="wrap mt-wrap">
        <main id="main-content" class="merit-tier-page">
"""
...
footer = """
        ...
        <footer>
          ...
          <p class="latin">Merit Tier System · <code>site/pages/merit-tier.html</code></p>
        </footer>
      </div>
    </div>
  </div>
  ...
  <script src="../assets/js/merit-tier.js" defer></script>
</body>
</html>
"""

(SRC.parent / "merit-tier.html").write_text(header + tier + block + footer, encoding="utf-8")
print("Wrote merit-tier.html")
