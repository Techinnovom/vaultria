"""Build site/pages/siven-healthcare.html from site/pages/_siven_healthcare_extracted.html."""
from pathlib import Path

ROOT = Path(__file__).resolve().parents[1]
SRC = ROOT / "site/pages/_siven_healthcare_extracted.html"
if not SRC.is_file():
    raise SystemExit(
        "Missing site/pages/_siven_healthcare_extracted.html — save the standalone Siven HTML there first."
    )
...
lead = """          <p class="tier-kicker"><a href="medical.html">Medical Corps</a> · Operations · Civic codex</p>
          <p class="zone-intro">The Siven Network: government-funded essential care, VYR-scaled services, CID-linked records with strict privacy, and a fully independent private sector.</p>
"""
...
<head>
  ...
  <title>Siven Healthcare — VAULTRIA</title>
  ...
  <link rel="stylesheet" href="../assets/css/siven-healthcare.css" />
</head>
<body data-nav-depth="1">
  ...
  <div class="site-shell">
    ...
    <div class="site-main">
      ...
      <div class="wrap siven-wrap">
        <main id="main-content" class="siven-healthcare-page">
"""
...
footer = """
        ...
        <footer>
          ...
          <p class="latin">Siven Healthcare System · <code>site/pages/siven-healthcare.html</code></p>
        </footer>
      </div>
    </div>
  </div>
  ...
  <script src="../assets/js/siven-healthcare.js" defer></script>
</body>
</html>
"""

(SRC.parent / "siven-healthcare.html").write_text(header + lead + block + footer, encoding="utf-8")
print("Wrote siven-healthcare.html")
